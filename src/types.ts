 ...
 * This file should be stored at ~/.config/bastionclaw/mount-allowlist.json
...
export interface ContainerConfig {
  ...
  webhookUrl?: string; // Per-channel Discord webhook URL
}
...
export interface RegisteredGroup {
  ...
  channel?: string; // whatsapp | telegram | discord | unknown
}
...
export interface Channel {
  ...
  // Optional: send an image with an optional text caption.
