...
```bash
npm run build
systemctl --user restart bastionclaw
```
...
>
> Check logs: `tail -f logs/bastionclaw.log`
...
- Check bot is started: `tail -f logs/bastionclaw.log`
...
8. Rebuild: `npm run build && launchctl kickstart -k gui/$(id -u)/com.bastionclaw`
