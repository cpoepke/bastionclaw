...
Only you (the server owner) can see this channel now. This is the channel you'll register with BastionClaw.

## Phase 4: Create a Discord Bot

1. Go to https://discord.com/developers/applications
2. Click **New Application**, name it (e.g., "BastionClaw")
3. Go to **Bot** tab:
   - Click **Reset Token** to generate a bot token
   - Copy the token — you'll need it next
   - **IMPORTANT**: Disable **Public Bot** — this prevents anyone from inviting your bot to their servers
   - Enable **Message Content Intent** under Privileged Gateway Intents
   - Enable **Server Members Intent** (optional, for member display names)
4. Go to **OAuth2** tab:
...
```bash
sqlite3 store/messages.db "INSERT INTO registered_groups (jid, name, folder, trigger_pattern, requires_trigger, channel) VALUES ('dc:CHANNEL_ID', 'CHANNEL_NAME', 'FOLDER_NAME', '@ASSISTANT_NAME', REQUIRES_TRIGGER, 'discord')"
```
